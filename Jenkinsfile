        ...
        stage("Build & Scan Catalogue") {
            steps {
                dir("catalogue") {
                    ...
                    trivy image --severity CRITICAL --exit-code 0 ${DOCKER_REGISTRY}/catalogue:latest > ../trivy-catalogue.txt
        ...
        stage("Build & Scan User") {
            steps {
                dir("user") {
                    ...
                    trivy image --severity CRITICAL --exit-code 0 ${DOCKER_REGISTRY}/user:latest > ../trivy-user.txt
        ...
        stage("Build & Scan Payment") {
            steps {
                dir("payment") {
                    ...
                    trivy image --severity CRITICAL --exit-code 0 ${DOCKER_REGISTRY}/payment:latest > ../trivy-payment.txt
